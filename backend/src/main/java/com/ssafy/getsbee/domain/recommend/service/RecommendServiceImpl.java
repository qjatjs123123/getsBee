...
public class RecommendServiceImpl implements RecommendService {
    ...
    public Slice<RecommendResponse> recommendPersonalizePosts(Long memberId, Pageable pageable) {
        ...
        return mapToRecommendResponse(categories, null, pageable);
    }
    ...
    public Slice<RecommendResponse> recommendRelatedPosts(Long postId, Pageable pageable) {
        ...
        return mapToRecommendResponse(categories, postId, pageable);
    }
    ...
    private Slice<RecommendResponse> mapToRecommendResponse(List<Category> categories, Long postId, Pageable pageable) {
        for (Category category : categories) {
            System.out.println(category.getValue());
        }
        return postRepository.findAllByCategory(categories, postId, pageable).map(post ->
