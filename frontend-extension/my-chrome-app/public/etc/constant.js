...
const TOOLTIP_PT = "5px";
const TOOLTIP_PL = "5px";

//BUTTON
const BTN_WIDTH = "25px";
const BTN_HEIGHT = "25px";
...
//COLORS
const COLORS = [
  { color: YELLOW_COLOR, colorh: YELLOW_COLOR_H },
  { color: BLUE_COLOR, colorh: BLUE_COLOR_H },
  { color: RED_COLOR, colorh: RED_COLOR_H },
];
