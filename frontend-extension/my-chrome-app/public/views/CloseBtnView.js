...
const CloseBtnView = Object.create(View);

CloseBtnView.setup = function (el) {
  this.init(el);

  return this;
};

CloseBtnView.getHtmlElement = function () {
